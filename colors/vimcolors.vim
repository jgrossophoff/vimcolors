...
let g:colors_name = "vimcolors"

set background=dark

" Baseline
hi Normal term=NONE cterm=NONE ctermfg=231 ctermbg=16 gui=NONE guifg=#ffffff guibg=#000000
...
hi LineNr term=NONE cterm=NONE ctermfg=242 ctermbg=NONE gui=NONE guifg=#6C6C6C guibg=NONE
...
hi Search term=underline cterm=underline ctermfg=231 ctermbg=16 gui=underline guifg=#ffffff guibg=#000000
